...
# ------------ Main Program Loop -----------
while not done:
	# Primary loop to allow multiple attempts until quitting
	...
	lander = mymodule.Lander(x_pos,y_pos, x_velocity, y_velocity, x_acceleration, \
	y_acceleration, engine_acceleration, screen, x_window_size, y_window_size)

	while not done or end_game_flag:
		...
		'''font = pygame.font.SysFont('Arial', telemetry_font_size, True, False)
